    ...
    >
        ...
        <div className="relative z-10 flex items-center space-x-4">
            ...
            <div className="flex-1">
                <p className="font-normal text-gray-900 dark:text-gray-100 text-sm">{title}</p>
                {message && (
                    <p className="text-xs text-gray-800 dark:text-gray-300 mt-1">{message}</p>
                )}
            </div>
        ...
        {duration && ( // Render progress bar only if duration is provided
            <div className="absolute bottom-0 left-0 h-1 w-full bg-gray-300/50 dark:bg-gray-600/50 rounded-b-xl overflow-hidden">
                <motion.div
                    ...
                    className={`h-full bg-gradient-to-r from-green-400 via-blue-400 to-sky-400 dark:from-orange-500 dark:via-orange-600 dark:to-orange-700`}
                ></motion.div>
            </div>
        )}
    </motion.div>
